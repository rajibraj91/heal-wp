...
$page_layout_meta = Heal_Group_Fields_Value::page_layout('heal');
$page_container_meta = Heal_Group_Fields_Value::page_container('heal','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area heal-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
