...
class Heal_Recent_Post_Widget extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'heal_popular_posts',
            esc_html__('Heal: Footer Recent Posts', 'heal-core'),
                    ...
                    <?php while ($recent_articles->have_posts()) : $recent_articles->the_post(); ?>
                        <li>
                            ...
                            <div class="footer__postcontent">
                                ...
                                <p><i class="far fa-clock"></i> <?php echo esc_html__('Time:', 'heal-core'); ?> <?php echo esc_html( get_the_time( 'g:i a' ) ); ?></p>
                            </div>
                        </li>
                    <?php endwhile; ?>
...
if (!function_exists('Heal_Recent_Post_Widget')) {
    function Heal_Recent_Post_Widget()
    {
        register_widget('Heal_Recent_Post_Widget');
    }
    add_action('widgets_init', 'Heal_Recent_Post_Widget');
}
