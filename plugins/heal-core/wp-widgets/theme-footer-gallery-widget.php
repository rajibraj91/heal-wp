...
if (class_exists('CSF')) {
    ...
    CSF::createWidget('heal_footer_gallery_widget', array(
        'title'       => esc_html__('Heal: Footer Gallery', 'heal-core'),
        ...
        'fields'      => array(
            array(
                ...
                'default' => esc_html__('Gallery Post', 'heal-core'),
            ),
            array(
    ...
    if (!function_exists('heal_footer_gallery_widget')) {
        function heal_footer_gallery_widget($args, $instance)
        {
                        ...
                        ?>
                            <li>
                                <div class="footer__gallerythumb">
                                    <a href="<?php echo esc_url($full_url); ?>" data-rel="lightcase">
