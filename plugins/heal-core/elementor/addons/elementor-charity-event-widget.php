 ...
 * @since 1.0.0
 */
class Theme_Event extends Widget_Base {

    public function get_name() { return 'event-widget'; }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'style6' => esc_html__( 'Style 6', 'heal-core' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'thumb_date',
            [
                'label' => esc_html__('Show Date Badge (on thumb/left)', 'heal-core'),
                'type'  => Controls_Manager::SWITCHER,
                'default' => '',
            ]
        );
                            ...
                            <?php if ( $query->have_posts() ) : ?>
                                <div class="col-lg-8 col-12">
                                    <div class="section-wrapper">
                                        <div class="event event-listview event-style4">
                                            <div class="row g-4">
                                                            ...
                                                            <div class="event__inner">
                                                                ...
                                                                <div class="event__content">
                                                                    <div class="event__list">
                                                                        ...
                                                                        <p class="mb-0">
                                                                            <b><?php esc_html_e('Time :-', 'heal-core'); ?></b>
                                                                            <?php echo esc_html($event_time); ?>
                                                                            <?php echo ' ' . esc_html__('/', 'heal-core') . ' '; ?>
                                                                            <b><?php esc_html_e('Place :-', 'heal-core'); ?></b>
                                                                        ...
                                                                        <div class="event__btn">
                                                                            <?php if ( 'yes' === $settings['reg_button_switcher'] && !empty($settings['reg_button_url']['url']) ) : ?>
                                                                                <a href="<?php echo esc_url($settings['reg_button_url']['url']); ?>"
                                                                                   class="default-btn move-right border-btn"
                                                                                   <?php echo !empty($settings['reg_button_url']['is_external']) ? 'target="_blank" rel="noopener"' : ''; ?>>
                                                                                    <span><?php echo esc_html( $settings['reg_button'] ); ?></span>
                                                                                </a>
                                                                            <?php endif; ?>
...
if ( method_exists( Plugin::instance()->widgets_manager, 'register_widget_type' ) ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Theme_Event() );
} else {
    Plugin::instance()->widgets_manager->register( new Theme_Event() );
}
