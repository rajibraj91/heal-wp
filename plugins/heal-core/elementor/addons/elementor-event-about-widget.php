...
class Theme_About2 extends Widget_Base {

	public function get_name() {
		return 'event-about-widget';
	}

	public function get_title() {
		return esc_html__( 'About 2', 'heal-core' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Theme_About2() );
