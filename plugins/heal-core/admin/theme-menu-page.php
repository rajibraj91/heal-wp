...
if (!class_exists('Heal_Core_Admin_Menu')) {

    class Heal_Core_Admin_Menu
    {
       /**
        * $instance
        * @since 1.0.0
        ...
        */
        ...
        public function theme_admin_menu_page()
        {
            ...
            //add menu page
            add_menu_page(
                esc_html__('Heal Theme Page', 'heal-core'),
                esc_html__('Heal Theme', 'heal-core'),
                'manage_options',
                'heal_theme_options',
                array($this, 'admin_options_fallback_function'),
                HEAL_CORE_ADMIN_ASSETS . '/img/icon.png',
                80
            );
        }
            ...
            $tab_menus = array(
                'service' => array(
                    array(
                        ...
                        'name' => sprintf(esc_html__('%s', 'heal-core'), 'Service'),
                        'id' => 'edit-service'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=service-cat&post_type=service',
                        'name' => sprintf(esc_html__('%s Categories', 'heal-core'), 'Service'),
                        'id' => 'edit-service-cat'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=service-tag&post_type=service',
                        'name' => sprintf(esc_html__('%s Tag', 'heal-core'), 'Service'),
                        'id' => 'edit-service-tag'
                    )
                ),
                'sermon' => array(
                    array(
                        'link' => 'edit.php?post_type=sermon',
                        'name' => sprintf(esc_html__('%s', 'heal-core'), 'Sermon'),
                        'id' => 'edit-sermon'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=sermon-cat&post_type=sermon',
                        'name' => sprintf(esc_html__('%s Categories', 'heal-core'), 'Sermon'),
                        'id' => 'edit-sermon-cat'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=sermon-tag&post_type=sermon',
                        'name' => sprintf(esc_html__('%s Tag', 'heal-core'), 'Sermon'),
                        'id' => 'edit-sermon-tag'
                    )
                ),
                'team' => array(
                    array(
                        ...
                        'name' => sprintf(esc_html__('%s', 'heal-core'), 'Team'),
                        'id' => 'edit-team'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=team-cat&post_type=team',
                        'name' => sprintf(esc_html__('%s Categories', 'heal-core'), 'Team'),
                        'id' => 'edit-team-cat'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=team-tag&post_type=team',
                        'name' => sprintf(esc_html__('%s Tag', 'heal-core'), 'Team'),
                        'id' => 'edit-team-tag'
                    )
                ),
                'event' => array(
                    array(
                        ...
                        'name' => sprintf(esc_html__('%s', 'heal-core'), 'Event'),
                        'id' => 'edit-event'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=event-cat&post_type=event',
                        'name' => sprintf(esc_html__('%s Categories', 'heal-core'), 'Event'),
                        'id' => 'edit-event-cat'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=event-tag&post_type=event',
                        'name' => sprintf(esc_html__('%s Tag', 'heal-core'), 'Event'),
                        'id' => 'edit-event-tag'
                    )
                ),
                'cause' => array(
                    array(
                        'link' => 'edit.php?post_type=cause',
                        'name' => sprintf(esc_html__('%s', 'heal-core'), 'Cause'),
                        'id' => 'edit-cause'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=cause-cat&post_type=cause',
                        'name' => sprintf(esc_html__('%s Categories', 'heal-core'), 'Cause'),
                        'id' => 'edit-cause-cat'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=cause-tag&post_type=cause',
                        'name' => sprintf(esc_html__('%s Tag', 'heal-core'), 'Cause'),
                        'id' => 'edit-cause-tag'
                    )
                ),
            );
        ...
        public function admin_menu_activation()
        {
            ...
            <script type="text/javascript">
                (function ($) {
                    ...
                    mainwrap = $('#toplevel_page_heal_theme_options');
                    ...
                    if (check) {
                        $('.wp-submenu.wp-submenu-wrap')
                            .find('a[href*="admin.php?page=toplevel_page_heal_theme_options"]')
                            .removeClass('current')
                            .parent('li')
                            .removeClass('current');
                    }
    ...
    if (class_exists('Heal_Core_Admin_Menu')) {
        Heal_Core_Admin_Menu::getInstance();
    }
